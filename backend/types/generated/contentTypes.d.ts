...
export interface ApiFutsalTeamFutsalTeam extends Struct.CollectionTypeSchema {
  collectionName: 'futsal_teams';
  info: {
    displayName: 'futsalTeam';
    pluralName: 'futsal-teams';
    singularName: 'futsal-team';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    matchDate: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    clubRole: Schema.Attribute.Enumeration<
      ['User', 'Member', 'Coordinator', 'Co_Coordinator']
    > &
